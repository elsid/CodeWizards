...
TEST(simulation, wizard_apply_cast_action_to_other_and_hit) {
    ...
    EXPECT_EQ(get_position(active_wizard), Point(1051.9858107268933, 1999.7594949917102));
...
TEST(simulation, wizard_and_minion) {
    ...
    EXPECT_EQ(get_position(wizard), Point(53.807548210142677, 2007.4848221895459));
