...
const std::unordered_map<model::SkillType, model::SkillType> SKILLS_DEPENDECIES({
...
const std::unordered_map<model::SkillType, std::vector<model::SkillType>> SKILLS_OPPOSITE({
    ...
    {model::SKILL_MOVEMENT_BONUS_FACTOR_PASSIVE_1, {model::SKILL_MOVEMENT_BONUS_FACTOR_PASSIVE_1}},
    {model::SKILL_MOVEMENT_BONUS_FACTOR_AURA_1, {model::SKILL_MOVEMENT_BONUS_FACTOR_AURA_1}},
    {model::SKILL_MOVEMENT_BONUS_FACTOR_PASSIVE_2, {model::SKILL_MOVEMENT_BONUS_FACTOR_PASSIVE_2}},
    {model::SKILL_MOVEMENT_BONUS_FACTOR_AURA_2, {model::SKILL_MOVEMENT_BONUS_FACTOR_AURA_2}},
